...
const navigation = {
  ...
  legal: [
    ...
    {
      name: "GitHub",
      href: "https://github.com/mohamed7235",
      icon: (
    ...
    {
      name: "Discord",
      href: "https://discord.com/users/1136474275616915477",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19.54 5.18A16.9 16.9 0 0 0 15.4 3.9l-.52 1.07a15.3 15.3 0 0 0-5.76 0L8.6 3.9c-1.48.25-2.86.68-4.14 1.28C1.83 9.05 1.12 12.83 1.48 16.55a16.7 16.7 0 0 0 5.1 2.57l1.24-1.68c-.68-.25-1.32-.57-1.92-.94l.46-.35c3.7 1.73 7.7 1.73 11.35 0l.47.35c-.6.37-1.25.69-1.93.94l1.24 1.68a16.7 16.7 0 0 0 5.1-2.57c.42-4.31-.72-8.05-3.05-11.37ZM8.7 15.15c-1.1 0-2-1.02-2-2.28s.88-2.29 2-2.29 2 1.03 2 2.29-.9 2.28-2 2.28Zm6.6 0c-1.1 0-2-1.02-2-2.28s.88-2.29 2-2.29 2 1.03 2 2.29-.9 2.28-2 2.28Z" fill="currentColor" />
        </svg>
      ),
    },
    {
      name: "Website",
      href: "https://bot-bay-kappa.vercel.app/",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
